...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials.dig(:mailjet, :MAILJET_API_KEY) 
  config.secret_key = Rails.application.credentials.dig(:mailjet, :MAILJET_SECRET_KEY)
  config.default_from = ''
